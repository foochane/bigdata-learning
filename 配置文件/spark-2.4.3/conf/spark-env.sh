...
# SPARK_LOCAL_IP=Node02

# 配置Job History Server
export SPARK_HISTORY_OPTS="-Dspark.history.ui.port=4000 -Dspark.history.retainedApplications=3 -Dspark.history.fs.logDirectory=hdfs://Node02:9000/spark-eventLog"
