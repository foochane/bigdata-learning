...
public class KafkaConsumer {
    ...
    private static String hdfsBasicPath = "hdfs://Node02:9000/user/app-analysis/data/";

    public static void main(String[] args) {
        // 创建配置
        Properties properties = new Properties();
        properties.put("zookeeper.connect", "Node02:2181");
        ...
        try {
            // 获取HDFS文件系统
            fs = FileSystem.get(new URI("hdfs://Node02:9000"), configuration, "hadoop");
        } catch (Exception e) {
            e.printStackTrace();
        }
